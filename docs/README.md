...
This folder contains the canonical project guides.
...
- [Email Quickstart](./EMAIL_QUICKSTART.md)
- [Email Implementation Summary](./EMAIL_IMPLEMENTATION_SUMMARY.md)

### GSAP

- [GSAP Refactoring](./GSAP_REFACTORING.md)

### Identity

- [Identity Composable Guide](./IDENTITY_COMPOSABLE_GUIDE.md)
